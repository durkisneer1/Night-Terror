...
class Mirror(BaseState):
    def __init__(self, app):
        ...
        self.blurred_normal_face = import_image(
            "assets/mirror/normal.png", scale=2, blur=True
        )
        self.distorted_face = import_image("assets/mirror/distorted.png", scale=2)
        self.blurred_distorted_face = import_image(
            "assets/mirror/distorted.png", scale=2, blur=True
        )
    ...
    def draw(self):
        ...
        if self.app.current_act > 1 and not self.normal_state:
